...
Command: npx gltfjsx@6.5.3 public/models/YuccaIdleLompat.glb 
*/
...
const YuccaIdleLompat = (props) => {
  const group = useRef();
  const { scene, animations } = useGLTF('/models/YuccaIdleLompat.glb');
  ...
  useEffect(() => {
    ...
    if (availableActions.length > 0) {
      ...
      if (action) {
        ...
        console.log('YuccaIdleLompat animation duration:', duration * 1000, 'ms');
...
export default YuccaIdleLompat

useGLTF.preload('/models/YuccaIdleLompat.glb')
