...
Command: npx gltfjsx@6.5.3 public/models/YuccaExit.glb 
*/
...
const YuccaExit = (props) => {
  const group = React.useRef()
  const { scene, animations } = useGLTF('/models/YuccaExit.glb')
...
export default YuccaExit

useGLTF.preload('/models/YuccaExit.glb')
