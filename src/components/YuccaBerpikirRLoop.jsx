...
Command: npx gltfjsx@6.5.3 public/models/YuccaBerpikirRLoop.glb 
*/
...
const YuccaBerpikirRLoop = (props) => {
  const group = React.useRef()
  const { scene, animations } = useGLTF('/models/YuccaBerpikirRLoop.glb')
...
export default YuccaBerpikirRLoop

useGLTF.preload('/models/YuccaBerpikirRLoop.glb')
