...
Command: npx gltfjsx@6.5.3 public/models/YuccaEntrance.glb 
*/
...
const YuccaEntrance = (props) => {
  ...
  useEffect(() => {
    // Log available actions and animations
    ...
    if (animations.length > 0) {
      ...
      if (action) {
        ...
        action.setLoop(true);  // Make it loop
  ...
  // Debug output for model structure
