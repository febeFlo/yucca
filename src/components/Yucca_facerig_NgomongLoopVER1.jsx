...
const Yucca_facerig_NgomongLoopVER1 = (props) => {
  const group = useRef();
  const { scene, animations } = useGLTF('/models/Yucca_facerig_NgomongLoopVER1.glb');
  ...
  useEffect(() => {
    ...
    if (availableActions.length > 0) {
      ...
      if (action) {
        ...
        console.log('VER1 animation duration:', duration * 1000, 'ms');
...
export default Yucca_facerig_NgomongLoopVER1;
useGLTF.preload('/models/Yucca_facerig_NgomongLoopVER1.glb');