...
Command: npx gltfjsx@6.5.3 public/models/YuccaEnterance.glb 
*/
...
const YuccaEnterance = (props) => {
  const group = React.useRef()
  const { scene, animations } = useGLTF('/models/YuccaEnterance.glb')
...
export default YuccaEnterance

useGLTF.preload('/models/YuccaEnterance.glb')
