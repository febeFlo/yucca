...
Command: npx gltfjsx@6.5.3 public/models/YuccaMendengar.glb 
*/
...
const YuccaMendengar = (props) => {
  const group = React.useRef()
  const { scene, animations } = useGLTF('/models/YuccaMendengar.glb')
...
export default YuccaMendengar

useGLTF.preload('/models/YuccaMendengar.glb')
