...
Command: npx gltfjsx@6.5.3 public/models/yucca_idleblend5.glb 
*/
...
const yucca_idleblend5 = (props) => {
  const group = React.useRef()
  const { scene, animations } = useGLTF('/models/yucca_idleblend5.glb')
...
export default yucca_idleblend5

useGLTF.preload('/models/yucca_idleblend5.glb')
