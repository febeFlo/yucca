...
const YuccaBerpikirR = (props) => {
  const group = useRef();
  const { scene, animations } = useGLTF('/models/YuccaBerpikirR.glb');
...
export default YuccaBerpikirR;

useGLTF.preload('/models/YuccaBerpikirR.glb');