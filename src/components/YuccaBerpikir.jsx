...
Command: npx gltfjsx@6.5.3 public/models/YuccaBerpikir.glb 
*/
...
const YuccaBerpikir = (props) => {
  const group = React.useRef()
  const { scene, animations } = useGLTF('/models/YuccaBerpikir.glb')
...
export default YuccaBerpikir

useGLTF.preload('/models/YuccaBerpikir.glb')
