...
Command: npx gltfjsx@6.5.3 public/models/YuccaSedih.glb 
*/
...
const YuccaSedih = (props) => {
  const group = React.useRef()
  const { scene, animations } = useGLTF('/models/YuccaSedih.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="metarig001" position={[-0.071, -0.118, 0]} scale={1.044}>
...
export default YuccaSedih

useGLTF.preload('/models/YuccaSedih.glb')
