...
const Yucca_facerig_NgomongLoopVER2 = (props) => {
  const group = useRef();
  const { scene, animations } = useGLTF('/models/Yucca_facerig_NgomongLoopVER2.glb');
  ...
  useEffect(() => {
    ...
    if (availableActions.length > 0) {
      ...
      if (action) {
        ...
        console.log('VER2 animation duration:', duration * 1000, 'ms');
...
export default Yucca_facerig_NgomongLoopVER2;
useGLTF.preload('/models/Yucca_facerig_NgomongLoopVER2.glb');